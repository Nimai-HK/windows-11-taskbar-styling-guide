...
```json
{
  ...
  "TimeStyle.CharacterSpacing":10,
  "DateStyle.Hidden":0,
  "DateStyle.TextColor":"",
  "DateStyle.TextAlignment":"Center",
  "DateStyle.FontSize":0,
  "DateStyle.FontFamily":"Nunito",
...
```json
{
  "controlStyles[0].styles[0]":"Background:=<WindhawkBlur BlurAmount=\"5\" TintColor=\"{ThemeResource SystemChromeMediumColor}\" TintOpacity=\"0.3\"  />",
  ...
  "controlStyles[19].styles[2]":"FontFamily=$ThFnt",
  "controlStyles[19].styles[3]":"FontWeight=Semibold",
  ...
  "controlStyles[23].styles[0]":"Background:=<SolidColorBrush Color=\"{ThemeResource SystemChromeMediumColor}\" Opacity=\"0.7\" />",
  ...
  "controlStyles[26].styles[2]":"FontFamily=$ThFnt",
  "controlStyles[26].styles[3]":"FontWeight=Semibold",
  ...
  "controlStyles[34].styles[0]":"Grid.Column=2",
  ...
  "controlStyles[43].styles[0]":"CornerRadius=$OuterRadius",
  "controlStyles[43].target":"Taskbar.TaskbarBackground#HoverFlyoutBackgroundControl > Grid > Rectangle#BackgroundFill",
  "controlStyles[44].styles[0]":"FontFamily=$ThFnt",
  "controlStyles[44].styles[1]":"FontSize=12",
  "controlStyles[44].styles[2]":"FontWeight=Bold",
  "controlStyles[44].target":"Windows.UI.Xaml.Controls.TextBlock#BatteryTextBlock",
  "controlStyles[45].styles[0]":"FontFamily=$ThFnt",
  "controlStyles[45].styles[1]":"FontWeight=Semibold",
  "controlStyles[45].styles[2]":"FontSize=14",
  "controlStyles[45].styles[3]":"RenderTransform:=<TranslateTransform Y=\"1\" />",
  "controlStyles[45].target":"Windows.UI.Xaml.Controls.ContentPresenter > SearchUx.SearchUI.SearchButtonControl > Windows.UI.Xaml.Controls.Grid > SearchUx.SearchUI.SearchBoxButton#SearchBox > SearchUx.SearchUI.SearchButtonRootGrid#SearchBoxButtonRootPanel > Windows.UI.Xaml.Controls.TextBlock#SearchBoxTextBlock",
  "controlStyles[46].styles[0]":"FontFamily=$ThFnt",
  "controlStyles[46].target":"Taskbar.TaskbarBackground#HoverFlyoutBackgroundControl",
  "controlStyles[47].styles[0]":"FontFamily=$ThFnt",
  "controlStyles[47].styles[1]":"FontWeight=Bold",
  "controlStyles[47].target":"Taskbar.TaskItemThumbnailView > Grid > Windows.UI.Xaml.Controls.TextBlock#DisplayNameTextBlock",
  "controlStyles[48].styles[0]":"Height=30",
  "controlStyles[48].target":"Windows.UI.Xaml.Controls.Grid#DynamicSearchBoxGleamContainer",
  "controlStyles[49].styles[0]":"Height=30",
  "controlStyles[49].target":"Windows.UI.Xaml.Controls.Button#GleamEntryPointButton > Windows.UI.Xaml.Controls.Border",
  "controlStyles[50].styles[0]":"FontFamily=$ThFnt",
  "controlStyles[50].styles[1]":"FontWeight=SemiBold",
  "controlStyles[50].styles[2]":"FontSize=13",
  "controlStyles[50].target":"Windows.UI.Xaml.Controls.ToolTip > Windows.UI.Xaml.Controls.ContentPresenter#LayoutRoot > TextBlock",
  "styleConstants[0]":"ThemeBlur=<WindhawkBlur BlurAmount=\"10\" TintColor=\"{ThemeResource SystemChromeMediumColor}\" TintOpacity=\"0.3\"  />",
  ...
  "themeResourceVariables[2]":"bgOpacity@Dark=0.5",
  "themeResourceVariables[3]":"bgLuminosity@Dark=0.85",
  "themeResourceVariables[1]":"Accent1@Light={ThemeResource SystemAccentColorDark2}",
  "themeResourceVariables[4]":"bgOpacity@Light=0.2",
  "themeResourceVariables[5]":"bgLuminosity@Light=1"
}
```
</details>
